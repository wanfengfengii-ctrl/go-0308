...
// New builds a Service backed by the given store and rule catalog, hydrating
// the in-memory lease coordinator from durable storage so that resource
// occupancy survives restart.
